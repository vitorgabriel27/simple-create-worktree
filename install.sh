...
ln -sfn "$SCRIPT_DIR/bin/git-merge-worktree" "$TARGET_DIR/git-merge-worktree"
ln -sfn "$SCRIPT_DIR/bin/git-worktree-sync" "$TARGET_DIR/git-worktree-sync"
...
echo "  $TARGET_DIR/git-merge-worktree -> $SCRIPT_DIR/bin/git-merge-worktree"
echo "  $TARGET_DIR/git-worktree-sync -> $SCRIPT_DIR/bin/git-worktree-sync"
echo ""
